...
public class NotificationApp {
	...
	public static void main(String[] args) {
		...
		Line line = new Line();
		//SNS 구현객체 생성		
		Instargram inst = new Instargram();
		Facebook facebook = new Facebook();

		//EventNotification객체에 Mail, Messenger, SNS 구현객체의 주소값 전달하기
		//EventNotification객체가 의존하는 (필요로하는, 사용하는)객체를 제공함
		//의존성 주입(Dependency Injection)
		//		-특정 객체가 필요로 하는 객체를 제 3자를 통해서 제공 받는 것
		...
		//이벤트 안내 보내기
		event.notice("홍보팀", "우수고객", "4월 우수고객 할인 이벤트", "구매 금액의 5%를 포인트로 적립합니다.");
		//주문내역 보내기
