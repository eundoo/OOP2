...
public interface UserRepository {		//abstract라는 키워드를 붙일 필요가 없다. //class라는 키워드가아니고 interface를 사용한다.
										//interface는 클래스가 아니고 껍데기다.
	/**
	 * 사용자 정보를 전달 받아서 저장소에 저장한다.
	 * @param user 사용자 정보가 저장된 User객체
	 */
