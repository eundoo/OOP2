...
public class ClassCastingApp3 {
	...
	public static void main(String[] args) {
		...
		//향상된 for문을 이용해서 배열에 저장된 다양한 Car객체를 순서대로 조회해서
		//Car객체면 운전기능, 정지기능, 실행해보기
		//PoliceCar객체면 운전기능, 정지기능, 순찰기능 실행해보기
		//FireTruck객체면 운전기능, 정지기능, 화재진압기능 해보기
		//Panzer객체면 운전기능, 정차기능, 순찰기능, 무기발사기능 실행해보기
		
		for (Car car : carList) {
			System.out.println();
			System.out.println("car 참조변수가 참조하는 객체 주요기능 확인");
			car.drive();
			car.stop();
