...
public class ATM {
	...
	//이체작업, 입금작업, 출금작업, 대출작업 등을 구현한 다양한 AbstractBanking의 하위 객체를 
	//참조할 수 있다.
	private AbstractBanking banking;
	
	//AbstractBanking 하위 객체의 주소값을 전달받는 setter메소드
	public void setBanking(AbstractBanking abstractBanking) {
